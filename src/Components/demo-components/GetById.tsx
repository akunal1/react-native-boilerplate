...
const StyledInput = memo(
  ({label, formikProps, formikKey, placeholder}: StyledInputProps) => {
    const inputStyles = {
      borderWidth: 1,
    ...
    return (
      <View
        style={{
          marginHorizontal: Spacing.mediumX + Spacing.tiny,
        ...
        <>
          <View style={{flexDirection: 'row'}}>
            ...
            {props.isApiLoading ? (
              ...
              <View
                style={{alignContent: 'center', alignSelf: 'center', top: 4}}>
                <Button
                  title="Submit"
...
GetEmployeeById.displayName = 'GetEmployeeById';
